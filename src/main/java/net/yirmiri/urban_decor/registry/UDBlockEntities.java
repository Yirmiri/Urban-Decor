...
public class UDBlockEntities {
    ...
    public static final BlockEntityType<FurnaceDecorBlockEntity> FURNACE_DECOR = Registry.register(Registries.BLOCK_ENTITY_TYPE,
            Identifier.of(UrbanDecor.MOD_ID, "furnace_decor"), FabricBlockEntityTypeBuilder.create(FurnaceDecorBlockEntity::new, UDBlocks.MICROWAVE).build());

    public static final BlockEntityType<SmokerDecorBlockEntity> SMOKER_DECOR = Registry.register(Registries.BLOCK_ENTITY_TYPE,
            Identifier.of(UrbanDecor.MOD_ID, "smoker_decor"), FabricBlockEntityTypeBuilder.create(SmokerDecorBlockEntity::new, UDBlocks.OVEN,
                    UDBlocks.DARK_OVEN).build());
