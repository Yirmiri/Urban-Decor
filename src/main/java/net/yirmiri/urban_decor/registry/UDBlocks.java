...
public class UDBlocks {
    ...
    public static final Supplier<Block> PORCELAIN_STAIRS = register("porcelain_stairs", () -> new StairsBlock(PORCELAIN_BLOCK.get().getDefaultState(), UDProperties.BlockP.PORCELAIN), true);
    ...
    public static final Supplier<Block> DARK_PORCELAIN_STAIRS = register("dark_porcelain_stairs", () -> new StairsBlock(DARK_PORCELAIN_BLOCK.get().getDefaultState(), UDProperties.BlockP.DARK_PORCELAIN), true);
    ...
    public static final Supplier<Block> PORCELAIN_BRICK_STAIRS = register("porcelain_brick_stairs", () -> new StairsBlock(PORCELAIN_BRICKS.get().getDefaultState(), UDProperties.BlockP.PORCELAIN), true);
    ...
    public static final Supplier<Block> DARK_PORCELAIN_BRICK_STAIRS = register("dark_porcelain_brick_stairs", () -> new StairsBlock(DARK_PORCELAIN_BRICKS.get().getDefaultState(), UDProperties.BlockP.DARK_PORCELAIN), true);
    ...
    public static final Supplier<Block> PORCELAIN_TILE_STAIRS = register("porcelain_tile_stairs", () -> new StairsBlock(PORCELAIN_TILES.get().getDefaultState(), UDProperties.BlockP.PORCELAIN), true);
    ...
    public static final Supplier<Block> DARK_PORCELAIN_TILE_STAIRS = register("dark_porcelain_tile_stairs", () -> new StairsBlock(DARK_PORCELAIN_TILES.get().getDefaultState(), UDProperties.BlockP.DARK_PORCELAIN), true);
    ...
    public static final Supplier<Block> CHECKERED_PORCELAIN_TILE_STAIRS = register("checkered_porcelain_tile_stairs", () -> new StairsBlock(CHECKERED_PORCELAIN_TILES.get().getDefaultState(), UDProperties.BlockP.PORCELAIN), true);
    ...
    public static final Supplier<Block> CHROMITE_STAIRS = register("chromite_stairs", () -> new StairsBlock(CHROMITE.get().getDefaultState(), UDProperties.BlockP.PORCELAIN), true);
    ...
    public static final Supplier<Block> POLISHED_CHROMITE_STAIRS = register("polished_chromite_stairs", () -> new StairsBlock(POLISHED_CHROMITE.get().getDefaultState(), UDProperties.BlockP.PORCELAIN), true);
    ...
    public static final Supplier<Block> STAINLESS_STEEL_BARS = register("stainless_steel_bars", () -> new PaneBlock(UDProperties.BlockP.STEEL_BARS), true);
