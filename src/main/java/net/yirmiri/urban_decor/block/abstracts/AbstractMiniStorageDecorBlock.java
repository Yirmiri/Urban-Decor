...
public abstract class AbstractMiniStorageDecorBlock extends AbstractDecorBlock implements BlockEntityProvider {
    public static final BooleanProperty OPEN = BooleanProperty.of("open");
    public static final BooleanProperty TRUE_OPEN = BooleanProperty.of("true_open");

    protected AbstractMiniStorageDecorBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
