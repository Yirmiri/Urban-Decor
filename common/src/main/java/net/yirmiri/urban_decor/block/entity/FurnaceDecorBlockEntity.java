...
public class FurnaceDecorBlockEntity extends AbstractFurnaceBlockEntity {
    ...
    protected Text getContainerName() {
        return Text.translatable("container.urban_decor.furnace");
    }
    ...
    void setOpen(BlockState state, boolean open) {
        world.setBlockState(getPos(), state.with(AbstractFurnaceDecorBlock.OPEN, open), 3);
    }

    void playSound(BlockState state, SoundEvent soundEvent) {
        Vec3i vec3i = (state.get(AbstractFurnaceDecorBlock.FACING)).getVector();
