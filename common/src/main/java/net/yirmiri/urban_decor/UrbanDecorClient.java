...
public class UrbanDecorClient {
    ...
    public static void init() {
        ...
        //CUTOUT
        RLServices.loadClient().registerBlockRenderType(UDBlocks.STAPLER.get(), RenderType.cutout());
        RLServices.loadClient().registerBlockRenderType(UDBlocks.FOLDABLE_SIGN.get(), RenderType.cutout());
        ...
        RLServices.loadClient().registerBlockRenderType(UDBlocks.PORCELAIN_TABLE.get(), RenderType.cutout());
