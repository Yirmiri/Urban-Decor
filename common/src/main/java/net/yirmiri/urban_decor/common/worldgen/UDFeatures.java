package net.yirmiri.urban_decor.common.worldgen;
...
public class UDFeatures {
    ...
    public static class ConfiguredFeatures {
        ...
        public static ResourceKey<ConfiguredFeature<?, ?>> createKey(String id) {
            return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryBuild(UrbanDecor.MOD_ID, id));
        }
    }
    ...
    public static class PlacedFeatures {
        ...
        public static ResourceKey<PlacedFeature> createKey(String id) {
            return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.tryBuild(UrbanDecor.MOD_ID, id));
        }
    }
}
