...
public class StorageDecorBlockEntity extends RandomizableContainerBlockEntity {
    private NonNullList<ItemStack> items;
    private final ContainerOpenersCounter openersCounter;

    public StorageDecorBlockEntity(BlockPos pos, BlockState state) {
        ...
        openersCounter = new ContainerOpenersCounter() {
            ...
            protected boolean isOwnContainer(Player player) {
                if (player.containerMenu instanceof ChestMenu) {
                    ...
                    return container == StorageDecorBlockEntity.this;
                } else {
                    return false;
                }
            }
