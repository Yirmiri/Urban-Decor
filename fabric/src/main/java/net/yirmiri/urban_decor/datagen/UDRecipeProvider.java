...
public class UDRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        stairBuilder(UDBlocks.CHROMITE_STAIRS.get(),
                ...
                .unlockedBy(getHasName(UDBlocks.CHROMITE.get()), has(UDBlocks.CHROMITE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHROMITE_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.CHROMITE_SLAB.get(),
                Ingredient.of(UDBlocks.CHROMITE.get()))
                .unlockedBy(getHasName(UDBlocks.CHROMITE.get()), has(UDBlocks.CHROMITE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHROMITE_SLAB.get())));

        wallBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.CHROMITE_WALL.get(),
                Ingredient.of(UDBlocks.CHROMITE.get()))
                .unlockedBy(getHasName(UDBlocks.CHROMITE.get()), has(UDBlocks.CHROMITE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHROMITE_WALL.get())));
        ...
        createFourForFourWendysMealRecipe(UDBlocks.POLISHED_CHROMITE.get(),
                Ingredient.of(UDBlocks.CHROMITE.get()))
                .unlockedBy(getHasName(UDBlocks.CHROMITE.get()), has(UDBlocks.CHROMITE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.POLISHED_CHROMITE.get())));
        ...
        stairBuilder(UDBlocks.POLISHED_CHROMITE_STAIRS.get(),
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.POLISHED_CHROMITE_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.POLISHED_CHROMITE_SLAB.get(),
                Ingredient.of(UDBlocks.POLISHED_CHROMITE.get()))
                .unlockedBy(getHasName(UDBlocks.POLISHED_CHROMITE.get()), has(UDBlocks.POLISHED_CHROMITE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.POLISHED_CHROMITE_SLAB.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, UDBlocks.CHECKERED_PORCELAIN_TILES.get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHECKERED_PORCELAIN_TILES.get()) + "_from_blocks"));
        ...
        stairBuilder(UDBlocks.CHECKERED_PORCELAIN_TILE_STAIRS.get(),
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHECKERED_PORCELAIN_TILE_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.CHECKERED_PORCELAIN_TILE_SLAB.get(),
                Ingredient.of(UDBlocks.CHECKERED_PORCELAIN_TILES.get()))
                .unlockedBy(getHasName(UDBlocks.CHECKERED_PORCELAIN_TILES.get()), has(UDBlocks.CHECKERED_PORCELAIN_TILES.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHECKERED_PORCELAIN_TILE_SLAB.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.TOILET.get(), 1)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.TOILET.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.DARK_TOILET.get(), 1)
                ...
                .unlockedBy(getHasName(UDItems.STEEL_PIPE.get()), has(UDItems.STEEL_PIPE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_TOILET.get())));

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.FAUCET.get(), 1)
                .define('#', UDItems.STEEL_PIPE.get())
                .pattern("##")
                .unlockedBy(getHasName(UDItems.STEEL_PIPE.get()), has(UDItems.STEEL_PIPE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.FAUCET.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.SINK.get(), 1)
                ...
                .unlockedBy(getHasName(UDItems.STEEL_PIPE.get()), has(UDItems.STEEL_PIPE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.SINK.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.DARK_SINK.get(), 1)
                ...
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STEEL_PIPE.get()), has(UDItems.STEEL_PIPE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_SINK.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.WASHING_MACHINE.get(), 1)
                ...
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STEEL_PIPE.get()), has(UDItems.STEEL_PIPE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.WASHING_MACHINE.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowels(DyeColor.BROWN.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowels(DyeColor.BROWN.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.WHITE.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.WHITE.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.LIGHT_GRAY.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.LIGHT_GRAY.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.GRAY.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.GRAY.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.BLACK.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.BLACK.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.RED.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.RED.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.ORANGE.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.ORANGE.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.YELLOW.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.YELLOW.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.LIME.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.LIME.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.GREEN.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.GREEN.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.CYAN.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.CYAN.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.LIGHT_BLUE.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.LIGHT_BLUE.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.BLUE.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.BLUE.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.PURPLE.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.PURPLE.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.MAGENTA.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.MAGENTA.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.getDyedTowelBlocks(DyeColor.PINK.getId()).get(), 4)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.getDyedTowelBlocks(DyeColor.PINK.getId()).get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.RIGID_GLASS.get(), 8)
                ...
                .pattern("#@#")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_NUGGET.get()), has(UDItems.STAINLESS_STEEL_NUGGET.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.RIGID_GLASS.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.TOILET_PAPER.get(), 1)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.TOILET_PAPER.get())));
        ...
        createTwoByTwoRecipe(UDBlocks.PORCELAIN_TILES.get(), 4,
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_TILES.get())));
        ...
        stairBuilder(UDBlocks.PORCELAIN_STAIRS.get(),
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.PORCELAIN_SLAB.get(),
                Ingredient.of(UDBlocks.PORCELAIN_BLOCK.get()))
                .unlockedBy(getHasName(UDBlocks.PORCELAIN_BLOCK.get()), has(UDBlocks.PORCELAIN_BLOCK.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_SLAB.get())));
        ...
        createTwoByTwoRecipe(UDBlocks.DARK_PORCELAIN_TILES.get(), 4,
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_TILES.get())));
        ...
        stairBuilder(UDBlocks.DARK_PORCELAIN_STAIRS.get(),
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.DARK_PORCELAIN_SLAB.get(),
                Ingredient.of(UDBlocks.DARK_PORCELAIN_BLOCK.get()))
                .unlockedBy(getHasName(UDBlocks.DARK_PORCELAIN_BLOCK.get()), has(UDBlocks.DARK_PORCELAIN_BLOCK.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_SLAB.get())));
        ...
        stairBuilder(UDBlocks.PORCELAIN_TILE_STAIRS.get(),
                ...
                .unlockedBy(getHasName(UDBlocks.PORCELAIN_TILES.get()), has(UDBlocks.PORCELAIN_TILES.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_TILE_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.PORCELAIN_TILE_SLAB.get(),
                Ingredient.of(UDBlocks.PORCELAIN_TILES.get()))
                .unlockedBy(getHasName(UDBlocks.PORCELAIN_TILES.get()), has(UDBlocks.PORCELAIN_TILES.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_TILE_SLAB.get())));
        ...
        stairBuilder(UDBlocks.DARK_PORCELAIN_TILE_STAIRS.get(),
                ...
                .unlockedBy(getHasName(UDBlocks.DARK_PORCELAIN_TILES.get()), has(UDBlocks.DARK_PORCELAIN_TILES.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_TILE_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.DARK_PORCELAIN_TILE_SLAB.get(),
                Ingredient.of(UDBlocks.DARK_PORCELAIN_TILES.get()))
                .unlockedBy(getHasName(UDBlocks.DARK_PORCELAIN_TILES.get()), has(UDBlocks.DARK_PORCELAIN_TILES.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_TILE_SLAB.get())));
        ...
        createTwoByTwoRecipe(UDBlocks.PORCELAIN_BRICKS.get(), 4,
                Ingredient.of(UDBlocks.PORCELAIN_BLOCK.get()))
                .unlockedBy(getHasName(UDBlocks.PORCELAIN_BLOCK.get()), has(UDBlocks.PORCELAIN_BLOCK.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_BRICKS.get())));

        stairBuilder(UDBlocks.PORCELAIN_BRICK_STAIRS.get(),
                Ingredient.of(UDBlocks.PORCELAIN_BRICKS.get()))
                .unlockedBy(getHasName(UDBlocks.PORCELAIN_BRICKS.get()), has(UDBlocks.PORCELAIN_BRICKS.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_BRICK_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.PORCELAIN_BRICK_SLAB.get(),
                Ingredient.of(UDBlocks.PORCELAIN_BRICKS.get()))
                .unlockedBy(getHasName(UDBlocks.PORCELAIN_BRICKS.get()), has(UDBlocks.PORCELAIN_BRICKS.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PORCELAIN_BRICK_SLAB.get())));
        ...
        createTwoByTwoRecipe(UDBlocks.DARK_PORCELAIN_BRICKS.get(), 4,
                Ingredient.of(UDBlocks.DARK_PORCELAIN_BLOCK.get()))
                .unlockedBy(getHasName(UDBlocks.DARK_PORCELAIN_BLOCK.get()), has(UDBlocks.DARK_PORCELAIN_BLOCK.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_BRICKS.get())));

        stairBuilder(UDBlocks.DARK_PORCELAIN_BRICK_STAIRS.get(),
                Ingredient.of(UDBlocks.DARK_PORCELAIN_BRICKS.get()))
                .unlockedBy(getHasName(UDBlocks.DARK_PORCELAIN_BRICKS.get()), has(UDBlocks.DARK_PORCELAIN_BRICKS.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_BRICK_STAIRS.get())));

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, UDBlocks.DARK_PORCELAIN_BRICK_SLAB.get(),
                Ingredient.of(UDBlocks.DARK_PORCELAIN_BRICKS.get()))
                .unlockedBy(getHasName(UDBlocks.DARK_PORCELAIN_BRICKS.get()), has(UDBlocks.DARK_PORCELAIN_BRICKS.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_PORCELAIN_BRICK_SLAB.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.STAINLESS_STEEL_LANTERN.get(), 1)
                ...
                .pattern("###")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_NUGGET.get()), has(UDItems.STAINLESS_STEEL_NUGGET.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.STAINLESS_STEEL_LANTERN.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.STAINLESS_STEEL_SOUL_LANTERN.get(), 1)
                ...
                .pattern("###")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_NUGGET.get()), has(UDItems.STAINLESS_STEEL_NUGGET.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.STAINLESS_STEEL_SOUL_LANTERN.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.STAINLESS_STEEL_DOOR.get(), 3)
                ...
                .pattern("##")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.STAINLESS_STEEL_DOOR.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.STAINLESS_STEEL_TRAPDOOR.get(), 1)
                ...
                .pattern("##")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.STAINLESS_STEEL_TRAPDOOR.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.FLOOR_LAMP.get(), 3)
                ...
                .pattern("!#!")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.FLOOR_LAMP.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, UDItems.STAINLESS_STEEL_INGOT.get(), 1)
                ...
                .requires(UDItems.STAINLESS_STEEL_NUGGET.get()).requires(UDItems.STAINLESS_STEEL_NUGGET.get()).requires(UDItems.STAINLESS_STEEL_NUGGET.get())
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_NUGGET.get()), has(UDItems.STAINLESS_STEEL_NUGGET.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDItems.STAINLESS_STEEL_INGOT.get()) + "_from_nugget"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.DISHWASHER.get(), 1)
                ...
                .unlockedBy(getHasName(UDItems.PORCELAIN.get()), has(UDItems.PORCELAIN.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DISHWASHER.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.DARK_DISHWASHER.get(), 1)
                ...
                .unlockedBy(getHasName(UDItems.DARK_PORCELAIN.get()), has(UDItems.DARK_PORCELAIN.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_DISHWASHER.get())));

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.CHROMITE.get(), 2)
                .define('#', Blocks.ANDESITE).define('@', UDItems.STAINLESS_STEEL_NUGGET.get())
                .pattern("@#")
                .pattern("#@")
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_NUGGET.get()), has(UDItems.STAINLESS_STEEL_NUGGET.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, UDBlocks.POLYPROPYLENE_BLOCK.get(), 1)
                ...
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.POLYPROPYLENE_BLOCK.get())));

        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.RED_DYE, 2)
                .requires(UDBlocks.getWrappedPolyanthous(WrapColor.CHERRY.getId()).get()).group("red_dye")
                .unlockedBy(getHasName(UDBlocks.getWrappedPolyanthous(WrapColor.CHERRY.getId()).get()), has(UDBlocks.getWrappedPolyanthous(WrapColor.CHERRY.getId()).get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(Items.RED_DYE) + "_polyanthous"));

        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BLUE_DYE, 2)
                .requires(UDBlocks.getWrappedPolyanthous(WrapColor.AZURE.getId()).get()).group("blue_dye")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, UDBlocks.PLASTIC_CHAIR.get(), 4)
                ...
                .pattern("# #")
                .unlockedBy(getHasName(UDItems.POLYPROPYLENE.get()), has(UDItems.POLYPROPYLENE.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.PLASTIC_CHAIR.get())));

        createCalenderRecipe(UDBlocks.OAK_CALENDAR.get(), Ingredient.of(Items.OAK_PLANKS))
                .unlockedBy(getHasName(Items.OAK_PLANKS), has(Items.OAK_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.OAK_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.SPRUCE_CALENDAR.get(), Ingredient.of(Items.SPRUCE_PLANKS))
                .unlockedBy(getHasName(Items.SPRUCE_PLANKS), has(Items.SPRUCE_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.SPRUCE_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.BIRCH_CALENDAR.get(), Ingredient.of(Items.BIRCH_PLANKS))
                .unlockedBy(getHasName(Items.BIRCH_PLANKS), has(Items.BIRCH_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.BIRCH_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.JUNGLE_CALENDAR.get(), Ingredient.of(Items.JUNGLE_PLANKS))
                .unlockedBy(getHasName(Items.JUNGLE_PLANKS), has(Items.JUNGLE_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.JUNGLE_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.ACACIA_CALENDAR.get(), Ingredient.of(Items.ACACIA_PLANKS))
                .unlockedBy(getHasName(Items.ACACIA_PLANKS), has(Items.ACACIA_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.ACACIA_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.DARK_OAK_CALENDAR.get(), Ingredient.of(Items.DARK_OAK_PLANKS))
                .unlockedBy(getHasName(Items.DARK_OAK_PLANKS), has(Items.DARK_OAK_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_OAK_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.MANGROVE_CALENDAR.get(), Ingredient.of(Items.MANGROVE_PLANKS))
                .unlockedBy(getHasName(Items.MANGROVE_PLANKS), has(Items.MANGROVE_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.MANGROVE_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.CHERRY_CALENDAR.get(), Ingredient.of(Items.CHERRY_PLANKS))
                .unlockedBy(getHasName(Items.CHERRY_PLANKS), has(Items.CHERRY_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHERRY_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.BAMBOO_CALENDAR.get(), Ingredient.of(Items.BAMBOO_PLANKS))
                .unlockedBy(getHasName(Items.BAMBOO_PLANKS), has(Items.BAMBOO_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.BAMBOO_CALENDAR.get())));

        createCalenderRecipe(UDBlocks.CRIMSON_CALENDAR.get(), Ingredient.of(Items.CRIMSON_PLANKS))
                .unlockedBy(getHasName(Items.CRIMSON_PLANKS), has(Items.CRIMSON_PLANKS))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CRIMSON_CALENDAR.get())));
        ...
        createGrandClockRecipe(UDBlocks.OAK_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_OAK_LOG),
        ...
        createGrandClockRecipe(UDBlocks.SPRUCE_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_SPRUCE_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.SPRUCE_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.BIRCH_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_BIRCH_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.BIRCH_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.JUNGLE_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_JUNGLE_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.JUNGLE_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.ACACIA_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_ACACIA_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.ACACIA_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.DARK_OAK_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_DARK_OAK_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.DARK_OAK_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.MANGROVE_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_MANGROVE_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.MANGROVE_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.CHERRY_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_CHERRY_LOG),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.CHERRY_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.BAMBOO_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_BAMBOO_BLOCK),
                Ingredient.of(UDItems.STAINLESS_STEEL_INGOT.get()))
                .unlockedBy(getHasName(UDItems.STAINLESS_STEEL_INGOT.get()), has(UDItems.STAINLESS_STEEL_INGOT.get()))
                .save(exporter, RunicLib.customid(UrbanDecor.MOD_ID, getSimpleRecipeName(UDBlocks.BAMBOO_GRANDFATHER_CLOCK.get())));

        createGrandClockRecipe(UDBlocks.CRIMSON_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_CRIMSON_STEM),
        ...
        createGrandClockRecipe(UDBlocks.WARPED_GRANDFATHER_CLOCK.get(), Ingredient.of(Items.STRIPPED_WARPED_STEM),
                Ingredient.of(Items.GOLD_INGOT))
                .unlockedBy(getHasName(Items.GOLD_INGOT), has(Items.GOLD_INGOT))
