    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        ;
            ...
            getOrCreateTagBuilder(UDTags.ItemT.TOWELS)
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "red_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "orange_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "yellow_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "lime_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "green_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "cyan_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "light_blue_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "blue_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "purple_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "magenta_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "pink_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "black_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "brown_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "white_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "gray_towel"))
                    .addOptional(RunicLib.customid(UrbanDecor.MOD_ID, "light_gray_towel"))
